...
Now we synthesize the design on yosys

![image](https://github.com/AniruddhaN2203/pes_asic_class/assets/142299140/998b9649-0875-4343-8a9a-4e820b8c26ff)
- We import the cells and read the verilog file as usual using ```read_verilog ternary_operator_mux.v```.
- Then we type ```synth -top ternary_operator_mux``` for synthesizing the design.

![image](https://github.com/AniruddhaN2203/pes_asic_class/assets/142299140/cb5c590d-1e95-4576-87cc-5b5ca746ca91)
- The following results should be displayed. As we can see a MUX is synthesized.
- Now we link the library files to the design using
```
abc -liberty ../my_lib//lib/sky130_fd_sc_hd__tt_025C_1v80.lib
```

![image](https://github.com/AniruddhaN2203/pes_asic_class/assets/142299140/6734bc82-973f-484f-a664-347c43b319b0)
- These are the results displayed.
- Now we generate the netlist file using the command
```
write_verilog -noattr ternary_operator_mux_net.v
```
The following file is generated:

![image](https://github.com/AniruddhaN2203/pes_asic_class/assets/142299140/6685d6f8-6f20-4748-a43e-d0e5b1a632b8)

- Now we can look at the design generated by typing ```show```.

![image](https://github.com/AniruddhaN2203/pes_asic_class/assets/142299140/d5385c6b-e33b-405b-a90c-7212047eb696)
